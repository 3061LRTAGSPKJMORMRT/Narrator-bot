...
module.exports = {
    ...
    run: async (message, args, client) => {
        ...
        if (timeLeft > 0) {
            ...
            let dailymsg = new MessageEmbed({ title: "Daily Rewards! Woohooo!", description: `${message.l10n("daily", { emoji: emote, number: Math.floor(Math.random() * 1000), prize: item })}${extra}` })
